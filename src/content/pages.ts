...
const langiaOnlinePageContent = {
  es: {
    ...
    who: {
      ...
      title: "Para adultos y older teens que quieren avanzar con estructura.",
      ...
      cards: [
        ...
        { title: "Older teens", body: "Una opción estructurada para adolescentes mayores que necesitan avanzar con acompañamiento serio." },
      ],
    },
    formats: {
      eyebrow: "Formatos",
    ...
    includes: {
      ...
      features: [
        { title: "Live classes", body: "Clases en vivo de 60 minutos con docentes expertos." },
        { title: "Level-based route", body: "Una ruta organizada desde tu nivel actual hacia objetivos más avanzados." },
        { title: "Live teacher feedback", body: "Corrección, orientación y feedback en tiempo real." },
        { title: "Langia TailorED customization", body: "Personalización del programa según tus metas, ritmo y contexto." },
        { title: "Rescheduling ability", body: "Flexibilidad para ajustar tu agenda dentro de las condiciones del programa." },
      ],
    },
    tailored: {
  ...
  pt: {
    ...
    who: {
      eyebrow: "Para quem é",
      title: "Para adultos e older teens que querem avançar com estrutura.",
      ...
      cards: [
        ...
        { title: "Older teens", body: "Uma opção estruturada para adolescentes mais velhos que precisam avançar com acompanhamento sério." },
      ],
    },
    formats: {
      eyebrow: "Formatos",
    ...
    includes: {
      ...
      features: [
        { title: "Live classes", body: "Aulas ao vivo de 60 minutos com professores especialistas." },
        { title: "Level-based route", body: "Uma rota organizada do seu nível atual para objetivos mais avançados." },
        { title: "Live teacher feedback", body: "Correção, orientação e feedback em tempo real." },
        { title: "Langia TailorED customization", body: "Personalização do programa conforme seus objetivos, ritmo e contexto." },
        { title: "Rescheduling ability", body: "Flexibilidade para ajustar sua agenda dentro das condições do programa." },
      ],
    },
    tailored: {
      eyebrow: "Langia TailorED",
...
const talkinClubPageContent = {
  es: {
    ...
    who: {
      ...
      cards: [
        { title: "Shy speakers", body: "Para quienes entienden más de lo que se atreven a decir." },
    ...
    includes: {
      ...
      features: [
        { title: "Private live sessions", body: "Sesiones uno a uno con un docente." },
        { title: "45-minute format", body: "Un formato ágil para practicar sin saturarte." },
        { title: "Topic-based practice", body: "Práctica basada en tus metas, situaciones y necesidades reales." },
        { title: "Live correction", body: "Corrección durante la conversación para mejorar en el momento." },
        { title: "Post-session feedback", body: "Observaciones después de la sesión para seguir avanzando." },
        { title: "Langia TailorED personalization", body: "Personalización de temas y práctica según tu contexto." },
      ],
    },
    tailored: {
      eyebrow: "Langia TailorED",
  ...
  pt: {
    ...
    who: {
      ...
      cards: [
        { title: "Shy speakers", body: "Para quem entende mais do que consegue dizer." },
    ...
    includes: {
      ...
      features: [
        { title: "Private live sessions", body: "Sessões individuais com um professor." },
        { title: "45-minute format", body: "Um formato ágil para praticar sem se sobrecarregar." },
        { title: "Topic-based practice", body: "Prática baseada nos seus objetivos, situações e necessidades reais." },
        { title: "Live correction", body: "Correção durante a conversa para melhorar no momento." },
        { title: "Post-session feedback", body: "Observações depois da sessão para continuar avançando." },
        { title: "Langia TailorED personalization", body: "Personalização de temas e prática conforme seu contexto." },
      ],
    },
    tailored: {
      eyebrow: "Langia TailorED",
...
const kidsTeensPageContent = {
  es: {
    ...
    includes: {
      ...
      features: [
        { title: "Live small-group classes", body: "Clases en vivo en Duo, Trio o Squad." },
        { title: "45-minute lessons", body: "Sesiones de 45 minutos pensadas para mantener atención y energía." },
        { title: "10-level route", body: "Una ruta clara para entender el progreso del estudiante." },
        { title: "Playful learning", body: "Actividades para aprender jugando y participar con confianza." },
        { title: "Monthly parent reports", body: "Reporte mensual para que los padres entiendan el avance." },
        { title: "Teacher communication", body: "Posibilidad de escribir al docente para feedback específico." },
        { title: "School support", body: "Apoyo para reforzar habilidades útiles en el colegio." },
        { title: "Langia TailorED personalization", body: "Personalización según edad, intereses, ritmo y necesidades." },
      ],
    },
    classFeel: {
  ...
  pt: {
    ...
    includes: {
      ...
      features: [
        { title: "Live small-group classes", body: "Aulas ao vivo em Duo, Trio ou Squad." },
        { title: "45-minute lessons", body: "Sessões de 45 minutos pensadas para manter atenção e energia." },
        { title: "10-level route", body: "Uma rota clara para entender o progresso do aluno." },
        { title: "Playful learning", body: "Atividades para aprender brincando e participar com confiança." },
        { title: "Monthly parent reports", body: "Relatório mensal para que os pais entendam o avanço." },
        { title: "Teacher communication", body: "Possibilidade de escrever ao professor para feedback específico." },
        { title: "School support", body: "Apoio para reforçar habilidades úteis na escola." },
        { title: "Langia TailorED personalization", body: "Personalização conforme idade, interesses, ritmo e necessidades." },
      ],
    },
    classFeel: {
  ...
  es: {
    ...
    levelTest: {
      ...
      blocks: [
        ...
        { title: "Próximamente", body: "The level test experience is coming soon." },
      ],
      cta: cta.es,
    },
    blog: {
