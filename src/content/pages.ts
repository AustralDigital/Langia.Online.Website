...
const programBlocks = {
  es: [
    { title: "Para quién es", body: "Cada programa responde a un perfil, una meta comunicativa y un ritmo de aprendizaje diferente." },
    { title: "Qué incluye la experiencia", body: "Clases en vivo, guía docente, práctica enfocada y recursos conectados con objetivos reales." },
    { title: "Cómo funciona el progreso", body: "El nivel, el seguimiento y la retroalimentación ayudan a orientar cada siguiente paso." },
  ],
  pt: [
    { title: "Para quem é", body: "Cada programa responde a um perfil, um objetivo de comunicação e um ritmo de aprendizagem diferente." },
    { title: "O que a experiência inclui", body: "Aulas ao vivo, orientação docente, prática focada e recursos conectados a objetivos reais." },
    { title: "Como o progresso funciona", body: "Nível, acompanhamento e feedback ajudam a orientar cada próximo passo." },
  ],
  en: [
    { title: "Who it is for", body: "Each program is shaped around a different learner profile, communication goal, and pace." },
    { title: "What the experience includes", body: "Live classes, teacher guidance, focused practice, and resources connected to real goals." },
    { title: "How progress works", body: "Level, ongoing feedback, and clear follow-up help guide every next step." },
  ],
} as const;
...
const aboutPageContent: Record<PageLanguage, AboutPageContent> = {
  es: {
    ...
    presence: {
      ...
      body: "Langia trabaja con estudiantes, familias y compañías en distintos países. Langia Language Solutions LLC está registrada en Wyoming, Estados Unidos, y opera online para acompañar una comunidad global.",
      languages: ["Inglés", "Francés", "Español", "Portugués"],
      locationNote: "Langia Language Solutions LLC está registrada en Wyoming, Estados Unidos.",
    },
    not: {
  ...
  pt: {
    ...
    presence: {
      ...
      body: "A Langia trabalha com alunos, famílias e empresas em diferentes países. A Langia Language Solutions LLC está registrada em Wyoming, Estados Unidos, e opera online para atender uma comunidade global.",
      languages: ["Inglês", "Francês", "Espanhol", "Português"],
      locationNote: "A Langia Language Solutions LLC está registrada em Wyoming, Estados Unidos.",
    },
    not: {
  ...
  en: {
    ...
    presence: {
      ...
      body: "Langia works with learners, families, and companies across countries. Langia Language Solutions LLC is registered in Wyoming, United States, and operates online for a global community.",
      languages: ["English", "French", "Spanish", "Portuguese"],
      locationNote: "Langia Language Solutions LLC is registered in Wyoming, United States.",
    },
    not: {
...
const legalPageContent: Record<PageLanguage, LegalPageContent> = {
  es: {
    hero: {
      ...
      note: "Estas políticas generales pueden actualizarse y complementarse con las condiciones específicas de cada servicio o acuerdo.",
    },
    nav: [
    ...
    sections: [
      ...
      { id: "cookies", title: "Cookies y analítica", body: ["Langia puede utilizar cookies, herramientas de analítica o tecnologías similares para entender el uso del sitio web, mejorar la experiencia del usuario y evaluar el desempeño de sus páginas. El uso de estas herramientas se rige por las políticas aplicables de los proveedores correspondientes."] },
  ...
  pt: {
    ...
    sections: [
      ...
      { id: "cookies", title: "Cookies e análise", body: ["A Langia pode utilizar cookies, ferramentas de análise ou tecnologias semelhantes para entender o uso do site, melhorar a experiência do usuário e avaliar o desempenho de suas páginas. O uso dessas ferramentas segue as políticas aplicáveis dos respectivos fornecedores."] },
  ...
  en: {
    ...
    sections: [
      ...
      { id: "cookies", title: "Cookies and analytics", body: ["Langia may use cookies, analytics tools, or similar technologies to understand website usage, improve user experience, and evaluate page performance. Use of these tools is governed by the applicable policies of their respective providers."] },
...
const workWithUsPageContent: Record<PageLanguage, WorkWithUsPageContent> = {
  ...
  en: {
    ...
    requirements: { eyebrow: "Requirements", title: "The basics for teaching well at Langia.", body: "The online experience depends on teacher preparation, connection quality, punctuality, and the ability to support learners.", items: [{ title: "Speak English", body: "English is a must-have requirement to collaborate with Langia." }, { title: "Teaching experience", body: "Previous experience teaching languages." }, { title: "Proficiency in the language you teach", body: "Strong command and the ability to correct clearly." }, { title: "Reliable computer", body: "A laptop or desktop that works reliably with Microsoft Teams or Zoom." }, { title: "Good internet connection", body: "Stable connection for live classes." }, { title: "Punctuality", body: "Respect for schedules and commitments." }, { title: "Empathy", body: "Ability to support learners with patience and closeness." }, { title: "Remote professionalism", body: "Clear communication and appropriate presentation in online classes." }], deviceNote: "We do not require a specific device brand. macOS, Windows, or Linux is fine as long as the computer is reliable and works with Teams or Zoom." },
    process: { eyebrow: "Process", title: "Express your interest and we'll review potential opportunities.", body: "This page does not guarantee an open position. It helps us learn about teachers whose experience may match future Langia needs.", steps: [{ title: "Complete the form", body: "Tell us about your profile, languages, and experience." }, { title: "We review your information", body: "We evaluate whether your profile matches future needs." }, { title: "We connect when there is a match", body: "If a relevant opportunity becomes available, the team may contact you." }, { title: "We define the collaboration", body: "When both sides see a strong match, we coordinate availability, terms, and next steps." }] },
    form: { title: "Express teacher interest", body: "Complete this form to share your profile with Langia.", note: "Submitting this form does not guarantee an open position. It helps us learn about your profile for future collaboration opportunities.", fields: { name: "Full name", email: "Email", whatsapp: "WhatsApp", country: "Country", teachingLanguages: "Languages you teach", spokenLanguages: "Languages you speak", experience: "Teaching experience", audience: "Main teaching audience", technicalConfirmation: "Technical confirmation", message: "Message", link: "LinkedIn / portfolio / website", availability: "Availability", notes: "Additional notes" }, placeholders: { name: "Your full name", email: "you@email.com", whatsapp: "Country code + number", country: "Country where you are", spokenLanguages: "Ex. English, Spanish, Portuguese", message: "Tell us about your experience and why you want to collaborate with Langia.", link: "Optional", availability: "Optional", notes: "Optional" }, teachingLanguageOptions: ["English", "French", "Spanish", "Portuguese"], experienceOptions: ["Less than 1 year", "1-2 years", "3-5 years", "5+ years"], audienceOptions: ["Adults", "Kids/Teens", "Test Prep", "Corporate", "Mixed"], technicalConfirmation: "I confirm that I have a reliable computer, a good internet connection, and can use Microsoft Teams or Zoom without issues.", submit: "Send interest through WhatsApp", requiredError: "Complete this field to continue.", configWarning: "We couldn’t open WhatsApp right now. Please try again later.", selectPlaceholder: "Select an option", fallbackNotProvided: "Not provided", yes: "Yes", no: "No" },
...
const programsOverview = {
  es: {
    ...
    finder: {
      ...
      body: "Conoce cómo orientamos tu punto de partida y habla con un asesor para elegir una ruta con confianza.",
    ...
    finalCta: {
      ...
      secondaryCta: "Recibir orientación de nivel",
      primaryHref: "/contact",
      secondaryHref: "/test-your-english-level",
    },
  },
  pt: {
    ...
    finder: {
      ...
      body: "Conheça como orientamos seu ponto de partida e fale com um consultor para escolher uma rota com confiança.",
    ...
    finalCta: {
      ...
      primaryCta: "Falar com a Langia",
      secondaryCta: "Receber orientação de nível",
      primaryHref: "/contact",
      secondaryHref: "/test-your-english-level",
    },
  },
  en: {
    ...
    finder: {
      ...
      body: "See how we clarify your starting point, then talk with an advisor to choose a path with confidence.",
    ...
    finalCta: {
      ...
      secondaryCta: "Get level guidance",
      primaryHref: "/contact",
      secondaryHref: "/test-your-english-level",
    },
  },
  ...
  es: {
    ...
    pricing: {
      ...
      labels: {
        ...
        installments: "Cuotas",
        payFull: "Pago completo con 15% de descuento",
  ...
  pt: {
    ...
    pricing: {
      ...
      labels: {
        ...
        payFull: "Pagamento completo com 15% de desconto",
...
const testPrepPageContent = {
  es: {
    hero: {
      ...
      title: "Prepárate con un plan claro para tu meta.",
      ...
      secondaryCta: "Ver precios",
      quickFacts: ["Clases privadas", "45 minutos", "Mínimo 40 clases", "3 simulacros"],
    },
    exams: {
      eyebrow: "Exámenes",
      ...
      groups: [
        { title: "Exámenes de inglés", items: ["IELTS", "TOEFL", "Cambridge C1/C2", "PTE Academic", "Duolingo English Test", "CELPIP"] },
        { title: "Exámenes de español", items: ["DELE", "SIELE", "TELC Español", "CELU", "AP Spanish"] },
        { title: "Exámenes de portugués", items: ["CELPE-Bras", "CAPLE"] },
        { title: "Exámenes de francés", items: ["DELF A1-B2", "DALF C1-C2", "TCF", "TEF"] },
      ],
    },
    who: {
      eyebrow: "Para quién es",
    ...
    process: {
      ...
      steps: [
        { title: "Simulacro diagnóstico", body: "En la primera clase, medimos tu punto de partida frente al formato del examen." },
        ...
        { title: "Simulacro final y reporte", body: "Cerramos con una medición final y un reporte de desempeño." },
      ],
    },
    includes: {
      eyebrow: "Qué incluye",
      ...
      features: [
        { title: "Clases privadas de 45 minutos", body: "Sesiones enfocadas en tu examen y tus prioridades." },
        { title: "Estrategia específica para tu examen", body: "Trabajo guiado según el formato, tipo de preguntas y criterios de la prueba." },
        { title: "Lectura, escritura, escucha y habla", body: "Preparación integral en las habilidades que evalúa el examen." },
        { title: "Corrección de escritura", body: "Corrección de respuestas escritas con orientación clara." },
        { title: "Retroalimentación oral", body: "Orientación para mejorar estructura, fluidez, precisión y seguridad." },
        { title: "Criterios de puntuación", body: "Práctica alineada con criterios de evaluación." },
        { title: "Manejo del tiempo", body: "Estrategias para responder mejor bajo presión." },
        { title: "Reportes de desempeño", body: "Reportes para entender desempeño, progreso y áreas por reforzar." },
      ],
    },
    skills: {
      eyebrow: "Habilidades",
      ...
      cards: [
        { title: "Lectura", body: "Lectura estratégica, manejo del tiempo y tipos de pregunta." },
        { title: "Escritura", body: "Estructura, precisión, coherencia y corrección." },
        { title: "Comprensión auditiva", body: "Comprensión, toma de notas y reconocimiento de información clave." },
        { title: "Expresión oral", body: "Fluidez, organización, precisión y seguridad." },
      ],
    },
    tailored: {
      eyebrow: "Langia TailorED",
      title: "La preparación se adapta a tus brechas.",
      body: "Langia TailorED conecta tu examen, meta, calendario, simulacros, habilidades por reforzar y retroalimentación docente para orientar la preparación con más precisión.",
    },
    mocks: {
      eyebrow: "Medición",
      title: "Tres simulacros para entender tu avance.",
      body: "Incluimos un simulacro diagnóstico, uno intermedio y uno final para dar seguimiento a tu desempeño. Los reportes ayudan a entender tu progreso, tus brechas y tu nivel de dedicación durante el programa.",
      cards: [
        { title: "Simulacro diagnóstico", body: "Primera clase" },
        { title: "Simulacro intermedio", body: "Mitad del programa" },
        { title: "Simulacro final", body: "Cierre del programa" },
      ],
    ...
    faq: {
      ...
      items: [
        ...
        { title: "¿Incluye simulacros?", body: "Sí. Incluye un simulacro diagnóstico, uno intermedio y uno final." },
  ...
  pt: {
    hero: {
      eyebrow: "Langia Test Prep",
      title: "Prepare-se com um plano claro para sua meta.",
      ...
      secondaryCta: "Ver preços",
      quickFacts: ["Aulas individuais", "45 minutos", "Mínimo de 40 aulas", "3 simulados"],
    },
    exams: {
      eyebrow: "Exames",
      ...
      groups: [
        { title: "Exames de inglês", items: ["IELTS", "TOEFL", "Cambridge C1/C2", "PTE Academic", "Duolingo English Test", "CELPIP"] },
        { title: "Exames de espanhol", items: ["DELE", "SIELE", "TELC Español", "CELU", "AP Spanish"] },
        { title: "Exames de português", items: ["CELPE-Bras", "CAPLE"] },
        { title: "Exames de francês", items: ["DELF A1-B2", "DALF C1-C2", "TCF", "TEF"] },
      ],
    },
    who: {
      eyebrow: "Para quem é",
    ...
    includes: {
      ...
      features: [
        { title: "Aulas individuais de 45 minutos", body: "Sessões focadas no seu exame e nas suas prioridades." },
        { title: "Estratégia específica para seu exame", body: "Trabalho guiado conforme o formato, tipos de perguntas e critérios da prova." },
        { title: "Leitura, escrita, escuta e fala", body: "Preparação integral nas habilidades avaliadas pelo exame." },
        { title: "Correção de escrita", body: "Correção de respostas escritas com orientação clara." },
        { title: "Feedback de expressão oral", body: "Orientação para melhorar estrutura, fluência, precisão e segurança." },
        { title: "Critérios de pontuação", body: "Prática alinhada aos critérios de avaliação." },
        { title: "Gestão do tempo", body: "Estratégias para responder melhor sob pressão." },
        { title: "Relatórios de desempenho", body: "Relatórios para entender desempenho, progresso e áreas a reforçar." },
      ],
    },
    skills: {
      eyebrow: "Habilidades",
      ...
      cards: [
        { title: "Leitura", body: "Leitura estratégica, gestão do tempo e tipos de pergunta." },
        { title: "Escrita", body: "Estrutura, precisão, coerência e correção." },
        { title: "Compreensão auditiva", body: "Compreensão, anotações e reconhecimento de informação-chave." },
        { title: "Expressão oral", body: "Fluência, organização, precisão e segurança." },
      ],
    },
    tailored: {
      eyebrow: "Langia TailorED",
  ...
  en: {
    hero: {
      eyebrow: "Langia Test Prep",
      title: "Prepare with a clear plan for your target score.",
...
const kidsTeensPageContent = {
  es: {
    hero: {
      ...
      title: "Aprendizaje en el que los padres pueden confiar y que los niños pueden disfrutar.",
    ...
    who: {
      ...
      cards: [
        { title: "Niños y adolescentes de 8 a 17", body: "Una ruta para aprender con apoyo, práctica y actividades adaptadas a la edad." },
  ...
  pt: {
    hero: {
      eyebrow: "Langia 4 Kids n Teens",
      title: "Aprendizagem em que os pais podem confiar e que os filhos podem aproveitar.",
    ...
    who: {
      ...
      cards: [
        { title: "Crianças e adolescentes de 8 a 17", body: "Uma rota para aprender com apoio, prática e atividades adaptadas à idade." },
...
const corporatePageContent = {
  es: {
    ...
    overview: {
      ...
      cards: [
        { title: "Capacitación lingüística", body: "Programas para empleados, líderes y equipos con objetivos profesionales." },
        { title: "Traducción", body: "Traducción de documentos, materiales y comunicación institucional." },
        { title: "Localización", body: "Adaptación cultural y lingüística para mercados, clientes y audiencias." },
        { title: "Interpretación en vivo", body: "Apoyo en reuniones, eventos, procesos comerciales o comunicación crítica." },
      ],
    },
    who: {
      eyebrow: "Para quién es",
  ...
  pt: {
    ...
    overview: {
      ...
      cards: [
        { title: "Treinamento linguístico", body: "Programas para colaboradores, líderes e equipes com objetivos profissionais." },
        { title: "Tradução", body: "Tradução de documentos, materiais e comunicação institucional." },
        { title: "Localização", body: "Adaptação cultural e linguística para mercados, clientes e públicos." },
        { title: "Interpretação ao vivo", body: "Apoio em reuniões, eventos, processos comerciais ou comunicação crítica." },
      ],
    },
    who: {
      eyebrow: "Para quem é",
    ...
    training: {
      ...
      cards: [
        ...
        { title: "Grupos por nível", body: "Organizamos colaboradores por nível, função, disponibilidade ou necessidade comunicativa." },
    ...
    process: {
      ...
      steps: [
        ...
        { title: "Lançamento", body: "Ativamos aulas, serviços ou grupos com coordenação operacional." },
    ...
    formats: {
      ...
      cards: [
        ...
        { title: "Equipes pequenas", body: "Grupos por nível, função ou necessidade comunicativa." },
...
const contactPageContent = {
  es: {
    ...
    form: {
      ...
      interestOptions: ["Orientación de nivel", "Langia Online", "Langia Talkin' Club", "Langia Test Prep", "Langia 4 Kids n Teens", "Langia Corporate", "Traducción", "Localización", "Interpretación en vivo", "No estoy seguro/a", "Otro"],
      submit: "Enviar por WhatsApp",
      requiredError: "Completa este campo para continuar.",
      configWarning: "No pudimos abrir WhatsApp en este momento. Inténtalo de nuevo más tarde.",
  ...
  pt: {
    ...
    form: {
      ...
      interestOptions: ["Orientação de nível", "Langia Online", "Langia Talkin' Club", "Langia Test Prep", "Langia 4 Kids n Teens", "Langia Corporate", "Tradução", "Localização", "Interpretação ao vivo", "Não tenho certeza", "Outro"],
      submit: "Enviar pelo WhatsApp",
      requiredError: "Preencha este campo para continuar.",
      configWarning: "Não foi possível abrir o WhatsApp neste momento. Tente novamente mais tarde.",
  ...
  en: {
    ...
    form: {
      ...
      interestOptions: ["Level guidance", "Langia Online", "Langia Talkin' Club", "Langia Test Prep", "Langia 4 Kids n Teens", "Langia Corporate", "Translation", "Localization", "Live interpretation", "Not sure yet", "Other"],
      submit: "Send through WhatsApp",
      requiredError: "Complete this field to continue.",
      configWarning: "We couldn’t open WhatsApp right now. Please try again later.",
...
export const pagesContent: Record<PageLanguage, Record<PageKey, MarketingPageContent>> = {
  es: {
    ...
    corporate: {
      ...
      blocks: [
        { title: "Diagnóstico del equipo", body: "Identificamos niveles, roles y objetivos de comunicación." },
        { title: "Diseño del programa", body: "Definimos contenidos, ritmo y formatos según la realidad de cada organización." },
        { title: "Seguimiento", body: "Coordinamos la implementación y damos visibilidad sobre asistencia y progreso." },
      ],
      cta: cta.es,
    ...
    legal: {
      ...
      subtitle: "Consulta los términos, la política de privacidad y las condiciones generales de los servicios de Langia.",
      blocks: [
        { title: "Términos y condiciones", body: "Condiciones generales para utilizar los programas, servicios y canales de Langia." },
        { title: "Política de privacidad", body: "Cómo recopilamos y utilizamos la información que compartes con Langia." },
        { title: "Políticas de servicio", body: "Información sobre pagos, reprogramaciones, disponibilidad y prestación de servicios." },
      ],
      cta: cta.es,
    ...
    workWithUs: {
      ...
      subtitle: "Conoce cómo colaborar como docente freelance en la red internacional de Langia.",
      blocks: [
        { title: "Red docente", body: "Buscamos profesores con experiencia, empatía y comunicación clara." },
        { title: "Colaboración remota", body: "Las oportunidades docentes se coordinan por servicios y disponibilidad." },
        { title: "Expresa tu interés", body: "Comparte tu perfil para que podamos considerarlo cuando exista una oportunidad compatible." },
      ],
      cta: cta.es,
    ...
    levelTest: {
      eyebrow: "Orientación de nivel",
      title: "Descubre tu punto de partida.",
      subtitle: "Aclara dónde estás, qué quieres lograr y qué tipo de acompañamiento puede ayudarte a avanzar con más confianza.",
      blocks: [
        { title: "Comparte tu contexto", body: "Cuéntanos cómo usas el idioma hoy, qué situaciones quieres dominar y cuál es tu meta." },
        { title: "Aclara tu nivel actual", body: "Revisamos tu experiencia, seguridad y necesidades para definir una referencia inicial útil." },
        { title: "Recibe una ruta recomendada", body: "Te orientamos hacia el programa, formato y siguiente paso que mejor encajan con tu momento." },
      ],
      cta: {
        title: "Tu ruta empieza con una conversación clara.",
        body: "Comparte tu meta con Langia y recibe orientación para elegir un punto de partida con confianza.",
  ...
  pt: {
    ...
    corporate: { eyebrow: "Corporativo", title: "Idiomas para equipes que cruzam fronteiras.", subtitle: "Programas ao vivo para empresas que precisam se comunicar melhor com clientes, mercados e equipes internacionais.", blocks: [{ title: "Diagnóstico da equipe", body: "Identificamos níveis, funções e objetivos de comunicação." }, { title: "Desenho do programa", body: "Definimos conteúdo, ritmo e formatos conforme a realidade de cada organização." }, { title: "Acompanhamento", body: "Coordenamos a implementação e damos visibilidade sobre presença e progresso." }], cta: cta.pt, corporatePage: corporatePageContent.pt },
    ...
    legal: { eyebrow: "Legal", title: "Informações legais e políticas.", subtitle: "Consulte os termos, a política de privacidade e as condições gerais dos serviços da Langia.", blocks: [{ title: "Termos e condições", body: "Condições gerais para usar os programas, serviços e canais da Langia." }, { title: "Política de privacidade", body: "Como coletamos e utilizamos as informações que você compartilha com a Langia." }, { title: "Políticas de serviço", body: "Informações sobre pagamentos, reagendamentos, disponibilidade e prestação de serviços." }], cta: cta.pt, legalPage: legalPageContent.pt },
    workWithUs: { eyebrow: "Trabalhe conosco", title: "Construa o futuro da aprendizagem com a Langia.", subtitle: "Conheça como colaborar como professor freelance na rede internacional da Langia.", blocks: [{ title: "Rede de professores", body: "Buscamos professores com experiência, empatia e comunicação clara." }, { title: "Colaboração remota", body: "As oportunidades docentes são coordenadas por serviços e disponibilidade." }, { title: "Expresse seu interesse", body: "Compartilhe seu perfil para que possamos considerá-lo quando houver uma oportunidade compatível." }], cta: cta.pt, workWithUsPage: workWithUsPageContent.pt },
    ...
    levelTest: { eyebrow: "Orientação de nível", title: "Descubra seu ponto de partida.", subtitle: "Entenda onde você está, o que quer alcançar e qual tipo de acompanhamento pode ajudar você a avançar com mais confiança.", blocks: [{ title: "Compartilhe seu contexto", body: "Conte como você usa o idioma hoje, quais situações quer dominar e qual é seu objetivo." }, { title: "Entenda seu nível atual", body: "Analisamos sua experiência, confiança e necessidades para definir uma referência inicial útil." }, { title: "Receba uma rota recomendada", body: "Orientamos você para o programa, formato e próximo passo que melhor combinam com seu momento." }], cta: { title: "Sua rota começa com uma conversa clara.", body: "Compartilhe seu objetivo com a Langia e receba orientação para escolher um ponto de partida com confiança.", primaryLabel: "Solicitar orientação", primaryHref: "/contact", secondaryLabel: "Comparar programas", secondaryHref: "/programs" } },
  ...
  en: {
    ...
    corporate: { eyebrow: "Corporate", title: "Languages for teams crossing borders.", subtitle: "Live programs for companies that need to communicate better with clients, markets, and international teams.", blocks: [{ title: "Team assessment", body: "We identify levels, roles, and communication goals." }, { title: "Program design", body: "We define content, pace, and formats around each organization’s reality." }, { title: "Follow-up", body: "We coordinate implementation and provide visibility into attendance and progress." }], cta: cta.en, corporatePage: corporatePageContent.en },
    ...
    legal: { eyebrow: "Legal", title: "Legal information and policies.", subtitle: "Review Langia’s terms, privacy policy, and general service conditions.", blocks: [{ title: "Terms and conditions", body: "General conditions for using Langia programs, services, and channels." }, { title: "Privacy policy", body: "How we collect and use information you share with Langia." }, { title: "Service policies", body: "Information about payments, rescheduling, availability, and service delivery." }], cta: cta.en, legalPage: legalPageContent.en },
    workWithUs: { eyebrow: "Work with us", title: "Build the future of learning with Langia.", subtitle: "Learn how to collaborate as a freelance teacher in Langia’s international network.", blocks: [{ title: "Teacher network", body: "We look for experienced, empathetic teachers who communicate clearly." }, { title: "Remote collaboration", body: "Teaching opportunities are coordinated around services and availability." }, { title: "Express your interest", body: "Share your profile so we can consider it when a relevant opportunity becomes available." }], cta: cta.en, workWithUsPage: workWithUsPageContent.en },
    ...
    levelTest: { eyebrow: "Level guidance", title: "Discover your starting point.", subtitle: "Clarify where you are, what you want to achieve, and the kind of support that can help you move forward with confidence.", blocks: [{ title: "Share your context", body: "Tell us how you use the language today, which situations you want to handle, and what you are working toward." }, { title: "Clarify your current level", body: "We consider your experience, confidence, and needs to establish a useful starting reference." }, { title: "Receive a recommended path", body: "We guide you toward the program, format, and next step that best fit your moment." }], cta: { title: "Your path starts with a clear conversation.", body: "Share your goal with Langia and get guidance for choosing a starting point with confidence.", primaryLabel: "Request guidance", primaryHref: "/contact", secondaryLabel: "Compare programs", secondaryHref: "/programs" } },
