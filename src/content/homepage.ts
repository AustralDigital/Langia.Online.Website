...
export const homepageContent = {
  es: {
    ...
    testimonials: {
      ...
      items: [
        { quote: "Desde las primeras clases sentí que el proceso tenía dirección. No era una clase genérica; trabajábamos exactamente en lo que necesitaba para comunicarme mejor.", name: "Sofía Martínez", role: "Estudiante de Langia Online", image: "/images/testimonials/testimonial-1.webp" },
        { quote: "Me costaba hablar porque pensaba demasiado en cada error. Con Langia empecé a practicar con más confianza y a soltarme en conversaciones reales.", name: "Daniel Herrera", role: "Estudiante de Talkin’ Club", image: "/images/testimonials/testimonial-2.webp" },
        { quote: "La preparación para mi examen fue mucho más clara de lo que esperaba. Entendí mis puntos débiles y pude practicar con una estrategia concreta.", name: "Camila Rojas", role: "Estudiante de Test Prep", image: "/images/testimonials/testimonial-3.webp" },
        { quote: "Como padre, me gustó que las clases fueran organizadas sin sentirse pesadas. Mi hijo disfrutaba las sesiones y nosotros podíamos seguir su progreso.", name: "Andrés Molina", role: "Padre Langia 4 Kids n Teens", image: "/images/testimonials/testimonial-4.webp" },
        { quote: "Lo que más valoré fue la cercanía del profesor. Me corregía con paciencia, me explicaba con claridad y me ayudaba a practicar situaciones de mi vida real.", name: "Valentina Gómez", role: "Estudiante de conversación", image: "/images/testimonials/testimonial-5.webp" },
        { quote: "Necesitaba mejorar mi comunicación para el trabajo. Las clases me ayudaron a ordenar mis ideas, participar mejor en reuniones y sentirme más seguro.", name: "Juan Sebastián Torres", role: "Estudiante profesional", image: "/images/testimonials/testimonial-6.webp" },
        { quote: "La experiencia se sintió flexible, pero no improvisada. Podía avanzar a mi ritmo y, al mismo tiempo, sabía qué estábamos construyendo en cada clase.", name: "Mariana Castillo", role: "Estudiante de programa online", image: "/images/testimonials/testimonial-7.webp" },
        { quote: "Langia TailorED hizo que el programa se sintiera más personal. Las clases conectaban con mis metas, mis errores frecuentes y las conversaciones que quería dominar.", name: "Nicolás Ramírez", role: "Estudiante Langia TailorED", image: "/images/testimonials/testimonial-8.webp" },
      ],
    },
    resources: {
  ...
  pt: {
    ...
    testimonials: {
      ...
      cta: "Começar agora",
      items: [
        { quote: "Desde as primeiras aulas senti que o processo tinha direção. Não era uma aula genérica; trabalhávamos exatamente no que eu precisava para me comunicar melhor.", name: "Sofia Martins", role: "Aluna Langia Online", image: "/images/testimonials/testimonial-1.webp" },
        { quote: "Eu tinha dificuldade para falar porque pensava demais em cada erro. Com a Langia, comecei a praticar com mais confiança e a me soltar em conversas reais.", name: "Daniel Ferreira", role: "Aluno Talkin’ Club", image: "/images/testimonials/testimonial-2.webp" },
        { quote: "A preparação para meu exame foi muito mais clara do que eu esperava. Entendi meus pontos fracos e consegui praticar com uma estratégia concreta.", name: "Camila Rocha", role: "Aluna Test Prep", image: "/images/testimonials/testimonial-3.webp" },
        { quote: "Como pai, gostei porque as aulas eram organizadas sem ficarem pesadas. Meu filho aproveitava as sessões e nós conseguíamos acompanhar o progresso.", name: "André Molina", role: "Pai Langia 4 Kids n Teens", image: "/images/testimonials/testimonial-4.webp" },
        { quote: "O que mais valorizei foi a proximidade do professor. Ele corrigia com paciência, explicava com clareza e me ajudava a praticar situações da vida real.", name: "Valentina Gomes", role: "Aluna de conversação", image: "/images/testimonials/testimonial-5.webp" },
        { quote: "Eu precisava melhorar minha comunicação para o trabalho. As aulas me ajudaram a organizar minhas ideias, participar melhor de reuniões e me sentir mais seguro.", name: "João Torres", role: "Aluno profissional", image: "/images/testimonials/testimonial-6.webp" },
        { quote: "A experiência foi flexível, mas não improvisada. Eu podia avançar no meu ritmo e, ao mesmo tempo, sabia o que estávamos construindo em cada aula.", name: "Mariana Castillo", role: "Aluna de programa online", image: "/images/testimonials/testimonial-7.webp" },
        { quote: "Langia TailorED fez o programa parecer mais pessoal. As aulas se conectavam com meus objetivos, meus erros frequentes e as conversas que eu queria dominar.", name: "Nicolas Ramirez", role: "Aluno Langia TailorED", image: "/images/testimonials/testimonial-8.webp" },
      ],
    },
    resources: {
      eyebrow: "Centro de recursos",
  ...
  en: {
    ...
    testimonials: {
      ...
      cta: "Start now",
      items: [
        { quote: "From the first classes, the process felt clear. It was not a generic lesson; we worked on exactly what I needed to communicate better.", name: "Sofia Martin", role: "Langia Online student", image: "/images/testimonials/testimonial-1.webp" },
        { quote: "I used to struggle with speaking because I overthought every mistake. With Langia, I started practicing with more confidence and speaking more naturally.", name: "Daniel Harper", role: "Talkin’ Club student", image: "/images/testimonials/testimonial-2.webp" },
        { quote: "My exam preparation felt much clearer than I expected. I understood my weak points and practiced with a concrete strategy.", name: "Camila Ross", role: "Test Prep student", image: "/images/testimonials/testimonial-3.webp" },
        { quote: "As a parent, I liked that the classes were organized without feeling heavy. My child enjoyed the sessions, and we could follow the progress.", name: "Andrew Molina", role: "Langia 4 Kids n Teens parent", image: "/images/testimonials/testimonial-4.webp" },
        { quote: "What I valued most was the teacher’s closeness. I was corrected with patience, explanations were clear, and we practiced real-life situations.", name: "Valentina Brooks", role: "Conversation student", image: "/images/testimonials/testimonial-5.webp" },
        { quote: "I needed to improve my communication for work. The classes helped me organize my ideas, participate better in meetings, and feel more confident.", name: "Sebastian Torres", role: "Professional learner", image: "/images/testimonials/testimonial-6.webp" },
        { quote: "The experience felt flexible, but not improvised. I could move at my own pace while still understanding what we were building in every class.", name: "Mariana Collins", role: "Online program student", image: "/images/testimonials/testimonial-7.webp" },
        { quote: "Langia TailorED made the program feel more personal. The classes connected with my goals, recurring mistakes, and the conversations I wanted to master.", name: "Nicholas Reed", role: "Langia TailorED student", image: "/images/testimonials/testimonial-8.webp" },
      ],
    },
    resources: {
